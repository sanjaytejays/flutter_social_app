  ...
  Future<void> _publishPost() async {
    ...
    try {
      ...
      final newPost = PostModel(
        ...
        postId: Uuid().v4() + DateTime.now().millisecondsSinceEpoch.toString(),
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                            'https://ui-avatars.com/api/?name=${Uri.encodeComponent(_currentUser!.name)}&background=0D8ABC&color=fff',
                          ),
                        ),
                      ),
                    ),
